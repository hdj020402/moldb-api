...
def query_molecule(inchi: str, base_url: str = "http://localhost:8000") -> dict[str, Any] | None:
    """
    ...
    Returns:
        dict[str, Any] | None: The molecule data if found, None otherwise.
...
def query_molecules_batch(inchis: list[str], base_url: str = "http://localhost:8000") -> dict[str, Any]:
    """
    ...
    Args:
        inchis: List of InChI identifiers to query.
        base_url: The base URL of the moldb-api service.

    Returns:
        dict mapping InChI to molecule data (None entries for not found).
